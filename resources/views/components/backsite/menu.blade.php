    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- @can('master_data_access') --}}
                <li class=" nav-item"><a href="#"><i class="{{ request()->is('backsite/materi') || request()->is('backsite/materi/*') || request()->is('backsite/*/materi') || request()->is('backsite/*/materi/*') || request()->is('backsite/consultation') || request()->is('backsite/consultation/*') || request()->is('backsite/*/consultation') || request()->is('backsite/*/consultation/*') || request()->is('backsite/config_payment') || request()->is('backsite/config_payment/*') || request()->is('backsite/*/config_payment') || request()->is('backsite/*/config_payment/*') ? 'bx bx-customize bx-flashing' : 'bx bx-customize' }}"></i><span class="menu-title" data-i18n="Master Data">Master Data</span></a>
                    <ul class="menu-content">

                        {{-- @can('materi_access') --}}
                            <li class="{{ request()->is('backsite/materi') || request()->is('backsite/materi/*') || request()->is('backsite/*/materi') || request()->is('backsite/*/materi/*') ? 'active' : '' }} ">
                                <a class="menu-item" href="{{ route('backsite.materi.index') }}">
                                    <i></i><span>Materi</span>
                                </a>
                            </li>
                        {{-- @endcan --}}
                        </ul>
